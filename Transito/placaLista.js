...
useEffect(() => {
   ...
   const fk = {
    ...
    const carregaForeignKeys = async (fk, setForeignKeyValues) => {
        const results = {};
        try {
            for (const key in fk) {
    ...
    return (
        <View style={styles.appContainer}>
            ...
            campos = {[     
                    ['text', 'placas'],
                    ['text', 'proprietario'],
                    ['picker', 'marca_id', foreignKeyValor.marca_id || []],
                    ['picker', 'modelo_id', foreignKeyValor.modelo_id || []],
                    ['picker', 'cor_id', foreignKeyValor.cor_id || []],
                    ['text', 'Ano'],
                    ['picker', 'combustivel_id',foreignKeyValor.combustivel_id || []],
                    ['text', 'renavam'],
                    ['text', 'chassi'],       
            ]}
